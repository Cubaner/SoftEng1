 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://webservices.bw.de/}mitarbeiterTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllMitarbeiterResponse {
    ...
    protected List<MitarbeiterTO> _return;
     ...
     * 
     */
    public List<MitarbeiterTO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<MitarbeiterTO>();
        }
        return this._return;
    }
