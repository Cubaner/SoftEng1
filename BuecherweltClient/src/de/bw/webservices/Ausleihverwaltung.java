...
public interface Ausleihverwaltung {
    ...
    public de.bw.webservices.Ausleihe neueAusleiheHinzufuegen(
        @WebParam(name = "arg0", targetNamespace = "")
        int arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        de.bw.webservices.Kunde arg1,
        @WebParam(name = "arg2", targetNamespace = "")
        de.bw.webservices.Buch arg2
    ) throws BuecherweltException_Exception;
    ...
    public java.util.List<de.bw.webservices.Ausleihe> getAllAusleihen();
    ...
    public de.bw.webservices.Ausleihe ausleiheSuchen(
        @WebParam(name = "arg0", targetNamespace = "")
        int arg0
    );
    ...
    public java.util.List<de.bw.webservices.Ausleihe> getAusleihenByKundenId(
        @WebParam(name = "arg0", targetNamespace = "")
        int arg0
    );
